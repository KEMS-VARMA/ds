...
public class InfixtoPostfix {
 ...
 while (operators.peek() != '(') { // STEP 5 of Algorithm.
 ...
 else if (ch == '+' || ch == '-' || ch == '*' || ch == '/') { // check precedence of each operator with
//top of the stack and process them
 while (operators.size() > 0 && operators.peek() != '(' && precedence(ch) <=
